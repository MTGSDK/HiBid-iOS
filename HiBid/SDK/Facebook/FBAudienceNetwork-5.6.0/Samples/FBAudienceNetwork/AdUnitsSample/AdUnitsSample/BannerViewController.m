...
@property (nonatomic, assign) FBAdSize adSize;
...
- (void)viewDidLayoutSubviews
{
    ...
    CGFloat bottomAlignedY = viewSize.height - self.adSize.size.height - insets.bottom;
    self.adView.frame = CGRectMake(insets.left,
                                   bottomAlignedY,
                                   viewSize.width - insets.right - insets.left,
                                   self.adSize.size.height);
}
...
- (void)loadAd
{
    ...
    self.adSize = isRegularWidth ? kFBAdSizeHeight90Banner : kFBAdSizeHeight50Banner;
